...
class VideoTest(object):
    ...
    def run(self, video_path, start_frame = 0, conf_thresh = 0.7):
        ...
        out = cv2.VideoWriter('../result/result_mossd_pedestrian0.7.avi',fourcc, 20.0, (int(self.input_shape[0]*vidar),self.input_shape[1]),True)
